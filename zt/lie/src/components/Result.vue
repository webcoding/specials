  ...
  <div class="result-page">
    ...
    <div v-else class="wait-img">
      ...
      <div class="avatar">
        ...
        <img v-else-if="user.isMe(questionId)" class="full-width-img" src="../assets/me.jpg">
    ...
    <div v-else>
      <div class="result">
        ...
        <div v-for="result in orderDesc(results)" class="friend">
          <img v-if="user.isYou(result.answerer)" src="../assets/me.jpg" class="avatar">
          <img v-else-if="user.isMe(result.answerer)" src="../assets/other.jpg" class="avatar">
...
export default {
  ...
  methods: {
    ...
    answerAgain () {
      ...
      const isConfirm = window.confirm('确认重新答题？')
  ...
  computed: {
    // 结果列表
    results () {
      const question = this.$root.userInfo[this.questionId]
