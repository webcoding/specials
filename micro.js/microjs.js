...
;(function () {
  var list = document.querySelectorAll('#test li a')
  var result = []
...
;(function () {
  ...
  var result = []
  list.forEach(function (item, index) {
    var title = item.querySelector('.hd').innerText,
    var subList = item.querySelectorAll('a')
    var subResult = []
...
;(function () {
  var searchURL = {
    ...
    "archdaily": {
      "search": "http://www.archdaily.com/search/?q=%keyword%",
    ...
    "cnn": {
      "search": "http://edition.cnn.com/search/?query=%keyword%",
      "home": "http://cnn.com"
    },
    "bbcnews": {
    ...
    "acfun": {
      "search": "http://www.acfun.tv/search.aspx#query=%keyword%",
      "home": "http://www.acfun.tv"
    },
    "500px": {
    ...
    "artstack": {
      "search": "http://theartstack.com/search/%keyword%",
    ...
    "googletrends": {
      "search": "https://www.google.com/trends/explore#q=%keyword%",
      "home": "https://www.google.com/trends/"
    },
    "spotify": {
      "search": "https://play.spotify.com/search/%keyword%",
    ...
    "wikihow": {
      "search": "http://zh.wikihow.com/Special:搜索/%keyword%",
    ...
    "appppp": {
      ...
      "home": "http://weixin.sogou.com/gzh?openid=oIWsFt-SZ_L7hkoujN3fKEPU1O28"
    },
    "panoramio": {
    ...
    "mogujie": {
      "search": "http://www.mogujie.com/book/search/%keyword%",
  ...
  var list = document.querySelectorAll('.catalog')
  var result = []
  list.forEach(function (item, index) {
    var title = item.querySelector('.catalogname').innerText
    var subList = item.querySelectorAll('div')
    var subResult = []
    subList.forEach(function (sub) {
      var img = sub.querySelector('img')
      var text = sub.querySelector('p').innerText
      var link = searchURL[img.id]
      console.log(link)
      subResult.push({
        title: text,
        url: link && link.home || '',
        icon: img.src,
        // desc: sub.getAttribute('title') || '',
      })
    })
    result.push({
      tag: title,
